...
from ..config1 import ONE_YEAR, GLOBAL_START_TIME, GLICKO_MAX_RD, TS_MAX_SIGMA
...
class Game1(Base):
    ...
    game_players1 = relationship("GamePlayer1", back_populates="game1")

"""
GamePlayer1 model
"""
class GamePlayer1(Base):
    __tablename__ = "game_players1"

    game_id = Column(Integer, ForeignKey("games1.id"), nullable=False)
    player_id = Column(Integer, ForeignKey("players1.id"), nullable=False)
    id = Column(Integer, primary_key=True, index=True)
    created_at = Column(DateTime, default=GLOBAL_START_TIME)
    ...
    game1 = relationship("Game1", back_populates="game_players1")
    player1 = relationship("Player1", back_populates="game_players1")
...
class Player1(Base):
    ...
    game_players1 = relationship("GamePlayer1", back_populates="player1")
    game_type_stats1 = relationship("PlayerGameTypeStats1", back_populates="player1")

"""
PlayerGameTypeStats1 model
"""
class PlayerGameTypeStats1(Base):
    __tablename__ = "player_game_type_stats1"
    ...
    player1 = relationship("Player1", back_populates="game_type_stats1")
