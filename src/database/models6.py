...
from ..config6 import ONE_YEAR, GLOBAL_START_TIME, GLICKO_MAX_RD, TS_MAX_SIGMA
...
class Game6(Base):
    ...
    game_players6 = relationship("GamePlayer6", back_populates="game6")

"""
GamePlayer6 model
"""
class GamePlayer6(Base):
    __tablename__ = "game_players6"

    game_id = Column(Integer, ForeignKey("games6.id"), nullable=False)
    player_id = Column(Integer, ForeignKey("players6.id"), nullable=False)
    id = Column(Integer, primary_key=True, index=True)
    created_at = Column(DateTime, default=GLOBAL_START_TIME)
    ...
    game6 = relationship("Game6", back_populates="game_players6")
    player6 = relationship("Player6", back_populates="game_players6")

"""
Player6 model
"""
class Player6(Base):
    __tablename__ = "players6"
    ...
    game_players6 = relationship("GamePlayer6", back_populates="player6")
    game_type_stats6 = relationship("PlayerGameTypeStats6", back_populates="player6")

"""
PlayerGameTypeStats6 model
"""
class PlayerGameTypeStats6(Base):
    __tablename__ = "player_game_type_stats6"
    ...
    player6 = relationship("Player6", back_populates="game_type_stats6")
