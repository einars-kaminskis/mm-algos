...
from ..config4 import ONE_YEAR, GLOBAL_START_TIME, GLICKO_MAX_RD, TS_MAX_SIGMA
...
class Game4(Base):
    ...
    game_players4 = relationship("GamePlayer4", back_populates="game4")

"""
GamePlayer4 model
"""
class GamePlayer4(Base):
    __tablename__ = "game_players4"

    game_id = Column(Integer, ForeignKey("games4.id"), nullable=False)
    player_id = Column(Integer, ForeignKey("players4.id"), nullable=False)
    id = Column(Integer, primary_key=True, index=True)
    created_at = Column(DateTime, default=GLOBAL_START_TIME)
    ...
    game4 = relationship("Game4", back_populates="game_players4")
    player4 = relationship("Player4", back_populates="game_players4")

"""
Player4 model
"""
class Player4(Base):
    __tablename__ = "players4"
    ...
    game_players4 = relationship("GamePlayer4", back_populates="player4")
    game_type_stats4 = relationship("PlayerGameTypeStats4", back_populates="player4")

"""
PlayerGameTypeStats4 model
"""
class PlayerGameTypeStats4(Base):
    __tablename__ = "player_game_type_stats4"
    ...
    player4 = relationship("Player4", back_populates="game_type_stats4")
