...
from ..config5 import ONE_YEAR, GLOBAL_START_TIME, GLICKO_MAX_RD, TS_MAX_SIGMA
...
class Game5(Base):
    ...
    game_players5 = relationship("GamePlayer5", back_populates="game5")

"""
GamePlayer5 model
"""
class GamePlayer5(Base):
    __tablename__ = "game_players5"

    game_id = Column(Integer, ForeignKey("games5.id"), nullable=False)
    player_id = Column(Integer, ForeignKey("players5.id"), nullable=False)
    id = Column(Integer, primary_key=True, index=True)
    created_at = Column(DateTime, default=GLOBAL_START_TIME)
    ...
    game5 = relationship("Game5", back_populates="game_players5")
    player5 = relationship("Player5", back_populates="game_players5")

"""
Player5 model
"""
class Player5(Base):
    __tablename__ = "players5"
    ...
    game_players5 = relationship("GamePlayer5", back_populates="player5")
    game_type_stats5 = relationship("PlayerGameTypeStats5", back_populates="player5")

"""
PlayerGameTypeStats5 model
"""
class PlayerGameTypeStats5(Base):
    __tablename__ = "player_game_type_stats5"
    ...
    player5 = relationship("Player5", back_populates="game_type_stats5")
