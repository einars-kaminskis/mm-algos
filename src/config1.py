...
REF_COEF_AND_GAMES = {
    "player_1": [(1.1, 500, 1.0, 0),(0.3, 500, 1.0, 0)],
    "player_2": [(1.1, 500, 1.0, 0), (0.75, 500, 1.0, 0)],
    "player_3": [(1.1, 330, 1.0, 0), (0.8, 330, 1.0, 0)] + [(0.82, 3, 1.0, 40) for _ in range(110)],
    "player_4": [(1.1, 330, 1.0, 0), (0.001, 330, 1.0, 0), (1.7, 330, 1.0, 0)],
    "player_5": [(1.1, 500, 1.0, 0),(0.3, 500, 1.0, 0)],
    "player_6": [(1.1, 500, 1.0, 0), (0.75, 500, 1.0, 0)],
    "player_7": [(1.1, 330, 1.0, 0), (0.8, 330, 1.0, 0)] + [(0.82, 3, 1.0, 40) for _ in range(110)],
    "player_8": [(1.1, 330, 1.0, 0), (0.001, 330, 1.0, 0), (1.7, 330, 1.0, 0)],
}
