...
REF_COEF_AND_GAMES = {
    "player_1": [(1.35, 500, 1.0, 0),(0.4, 500, 1.0, 0)],
    "player_2": [(1.35, 500, 1.0, 0), (0.8, 500, 1.0, 0)],
    "player_3": [(1.35, 330, 1.0, 0), (0.8, 330, 1.0, 0)] + [(0.8, 3, 1.0, 40) for _ in range(110)],
    "player_4": [(1.35, 330, 1.0, 0), (0.0001, 330, 1.0, 0), (1.7, 330, 1.0, 0)],
