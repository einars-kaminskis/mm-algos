...
# }
REF_COEF_AND_GAMES = {
    "player_1": [(1.4, 200, 1.0, 0),(0.3, 200, 1.0, 0)],
    "player_2": [(1.4, 200, 1.0, 0), (0.91, 200, 1.0, 0)],
    "player_3": [(1.4, 133, 1.0, 0), (0.91, 133, 1.0, 0)] + [(0.91, 4, 1.0, 30) for _ in range(30)],
    "player_4": [(1.4, 133, 1.0, 0), (0.05, 133, 1.0, 0), (1.9, 133, 1.0, 0)],
