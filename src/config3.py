...
# }
REF_COEF_AND_GAMES = {
    "player_1": [(1.2, 200, 1.0, 0),(0.15, 200, 1.0, 0)],
    "player_2": [(1.2, 200, 1.0, 0), (0.91, 200, 1.0, 0)],
    "player_3": [(1.2, 133, 1.0, 0), (0.91, 133, 1.0, 0)] + [(0.91, 4, 1.0, 30) for _ in range(30)],
    "player_4": [(1.2, 133, 1.0, 0), (0.01, 133, 1.0, 0), (1.7, 133, 1.0, 0)],
